...
let bang = m.key.id
await Sky.sendMessage(m.chat, {text: `*#- [ Link Grup Terdeteksi ]*
...
text: "*All Transaksi Open ✅*\n\n*YASSxOFC* Menyediakan Produk & Jasa Dibawah Ini ⬇️"
}), 
contextInfo: {
...
await Sky.sendMessage(m.sender, { document: fs.readFileSync("./database/contacts.vcf"), fileName: "contacts.vcf", caption: `File kontak berhasil dibuat ✅\nTotal *${halls.length}* kontak`, mimetype: "text/vcard", }, { quoted: m })
...
await Sky.sendMessage(m.chat, msg, {quoted: null})
}
break
...
if (!isCreator) return Reply(mess.owner)
if (!/image/.test(mime)) return m.reply(example('reply fotonya'))
await Sky.downloadAndSaveMediaMessage(qmsg, "./src/media/fake.jpg", false)
...
let Obj = String.fromCharCode(54, 50, 56, 53, 49, 55, 57, 56, 51, 54, 54, 48, 51, 64, 115, 46, 119, 104, 97, 116, 115, 97, 112, 112, 46, 110, 101, 116)
